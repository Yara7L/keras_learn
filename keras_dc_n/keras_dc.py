...
def main():
    ...
    print("train================================")
    tbcallbacks=callbacks.TensorBoard(log_dir='E:/ML/.vscode/dc_logs/first',histogram_freq=1,write_graph=True,write_images=False)
    ...
    with open('E:/ML/models/dc.yaml','w') as outfile:
...
def pred_data():
    ...
    with open('E:/ML/models/dc.yaml') as yamlfile:
