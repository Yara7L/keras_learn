...
def main():
    ...
    # print("train================================")
    # best_model=callbacks.ModelCheckpoint("E:/ML/models/keras_dc_1.h5",monitor='val_loss',verbose=1,save_best_only=True,mode='min')
    # tbcallbacks=callbacks.TensorBoard(log_dir='E:/ML/.vscode/dc_logs/keras_dc_1',histogram_freq=1,write_graph=True,write_images=False)
    ...
    # with open('E:/ML/models/keras_dc_1.yaml','w') as outfile:
    #     outfile.write(yaml_string)


def pred_data():

    with open('E:/ML/models/keras_dc_1.yaml') as yamlfile:
        loaded_model_yaml=yamlfile.read()

    model=model_from_yaml(loaded_model_yaml)
    model.load_weights('E:/ML/models/keras_dc_1.h5')
